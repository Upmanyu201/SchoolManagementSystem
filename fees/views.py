...
def get_fee_group_context(request):
    ...
    try:
        ...
        context_info = {
            ...
            'fee_type': fee_group.fee_type,
            'fee_group_name': fee_group.fee_group,
            'requires_months': 'monthly' in fee_group.fee_group.lower() or 'tuition' in fee_group.fee_group.lower(),
            'requires_classes': 'class based' in fee_group.fee_type.lower() or 'tuition' in fee_group.fee_group.lower(),
            'requires_stoppages': 'stoppage based' in fee_group.fee_type.lower() or 'transport' in fee_group.fee_group.lower(),
            'requires_custom_name': 'general' in fee_group.fee_type.lower(),
        }
